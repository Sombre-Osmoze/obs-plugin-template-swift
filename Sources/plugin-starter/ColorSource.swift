...
public struct ColorSource {
  ...
  internal static func getDefaults() -> GetDefaultsClosure {
    return { settings in
      obs_data_set_default_int(settings, "color", 0xFFD1_D1D1)
  ...
  internal static func getWidth() -> GetSizeClosure {
    return { source in
      ...
      return withUnsafeBound(to: ColorSource.self, ptr: source) { _ in 100 }
    }
  }
  ...
  static func defaultPreset() -> obs_source_info {
